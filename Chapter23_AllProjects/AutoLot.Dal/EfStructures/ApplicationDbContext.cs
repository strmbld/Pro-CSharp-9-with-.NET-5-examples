...
namespace AutoLot.Dal.EfStructures
{
    public partial class ApplicationDbContext : DbContext
    {
        ...
        public override int SaveChanges()
        {
            ...
            {
                // log
                throw new CustomConcurrencyException("Concurrency exception occured", e);
            }
            catch (RetryLimitExceededException e)
            {
                // DbResiliency retry limit exceeded; log
                throw new CustomRetryLimitExceededException("RetryLimitExceeded exception occured; check db server", e);
            }
            catch (Exception e)
            {
                // log
                throw new CustomException("An error occured while updating the database", e);
            }
        }
